...
const STATIC_QUICK_ADD_ITEMS = [
    ...
    { to: "/add-purchases-orders", icon: "isax-document", label: "Purchase Order" },
    { to: "/add-quotation", icon: "isax-document-download", label: "Quotation" },
    { to: "/add-delivery-challan", icon: "isax-document-forward", label: "Delivery Challan" },
];
                    ...
                    <div className="nav user-menu nav-list">
                            ...
                            <div className="dropdown me-3">
                                ...
                                <ul className="dropdown-menu dropdown-menu-start p-2">
                                    {STATIC_QUICK_ADD_ITEMS.map((item, index) => (
                                        <li key={index}>
                                            <Link className="dropdown-item d-flex align-items-center" to={item.to}>
                                ...
                                <ol className="breadcrumb breadcrumb-divide mb-0">
                                    {breadcrumbRoot ? (
                                        <li className="breadcrumb-item d-flex align-items-center">
                                            <Link to={breadcrumbRoot.href}>{breadcrumbRoot.label}</Link>
                                        </li>
                                    ) : (
                                        <li className="breadcrumb-item d-flex align-items-center">
                                            <Link to="/">
                                    ...
                                    {!breadcrumbParent && breadcrumbTitle !== (breadcrumbRoot?.label || "Home") && (
                                        <li className="breadcrumb-item active" aria-current="page">
                                            {breadcrumbTitle}
                                        </li>
                                    )}
                        ...
                        <div className="d-flex align-items-center">
                                ...
                                <div className="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style={{ minHeight: "300px" }}>
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-auto">
                                                <div className="dropdown">
                                                    <a className="dropdown-toggle drop-arrow-none link-dark" data-bs-offset="0,15" data-bs-toggle="dropdown" href="#">
                                                        <i className="isax isax-setting-2 fs-16 text-body align-middle" />
                                                    </a>
                                                    <div className="dropdown-menu dropdown-menu-end">
                                                        <a className="dropdown-item" href="#"><i className="ti ti-bell-check me-1" />Mark as Read</a>
                                                        <a className="dropdown-item" href="#"><i className="ti ti-trash me-1" />Delete All</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="notification-body position-relative z-2 rounded-0" data-simplebar>
                                        {STATIC_NOTIFICATIONS.map((notif) => (
                                            <div key={notif.id} className="dropdown-item notification-item py-2 text-wrap border-bottom">
                                                <div className="d-flex">
                                                    <div className="me-2 position-relative flex-shrink-0">
                                                        {notif.avatar ? (
                                                            <img alt="User" className="avatar-md rounded-circle" src={notif.avatar} />
                                                        ) : (
                                                            <div className={`avatar-sm me-2 ${notif.bgColor}`}>
                                                                <span className="avatar-title rounded-circle">{notif.initial}</span>
                                                            </div>
                                                        )}
                                                    </div>
                                                    <div className="flex-grow-1">
                                                        <p className="mb-0 fw-semibold text-dark">{notif.name}</p>
                                                        <p className="mb-1 text-wrap fs-14">{notif.message}</p>
                                                        <span className="fs-12">
                                                            <i className="isax isax-clock me-1" />{notif.time}
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="p-2 rounded-bottom border-top text-center">
                                        <Link className="text-center fw-medium fs-14 mb-0" to="/notifications">View All</Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="me-2 theme-item">
                                <a className="theme-toggle btn btn-menubar" href="#" id="dark-mode-toggle">
                                    <i className="isax isax-moon" />
                                </a>
                                <a className="theme-toggle btn btn-menubar" href="#" id="light-mode-toggle">
                            ...
                            <div className="dropdown profile-dropdown">
                                ...
                                <div className="dropdown-menu p-2 dropdown-menu-end">
                                    ...
                                    <Link className="dropdown-item d-flex align-items-center py-2" to="/my-exports">
                                        <i className="isax isax-document-download me-2 text-body" /> My Exports
                                    </Link>

                                    <hr className="dropdown-divider my-2" />

                                    <Link className="dropdown-item d-flex align-items-center py-2 logout" to="#" onClick={handleLogout}>
                            ...
                            <div className="dropdown mobile-user-menu profile-dropdown">
                                ...
                                <div className="dropdown-menu p-2 mt-0 dropdown-menu-end">
                                    ...
                                    <Link className="dropdown-item d-flex align-items-center py-2" to="/my-exports">
                                        <i className="isax isax-document-download me-2" /> My Exports
                                    </Link>
