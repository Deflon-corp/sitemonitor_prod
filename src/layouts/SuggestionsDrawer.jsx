        ...
        <>
            ...
            >
                ...
                <div className="d-flex align-items-center gap-3 p-4 border-bottom bg-white">
                    ...
                    <h5 className="mb-0 fw-semibold text-body" id="suggestions-drawer-title">
                ...
                <div className="p-4 flex-grow-1">
                    {submitted ? (
                        <div className="alert alert-success d-flex align-items-center mb-0 rounded-3" role="alert">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        rows={10}
                                        style={{ minHeight: "220px", width: "100%", resize: "vertical" }}
                                        value={message}
                                ...
                                <div className="d-flex gap-2 justify-content-end pt-2">
                                    ...
                                    <button type="submit" className="btn bg-primary-gradient text-white">
                                        Submit
                                    </button>
                                </div>
                            </form>
