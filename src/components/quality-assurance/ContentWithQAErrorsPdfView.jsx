...
export default function ContentWithQAErrorsPdfView() {
    ...
    <div className="d-flex flex-column h-100">
      <div className="mb-3">
        <h5 className="mb-1 d-flex align-items-center gap-2 text-body">
          <i className="isax isax-document-text fs-20 text-primary" aria-hidden="true"></i> PDF Documents
        </h5>
        <p className="text-muted fs-13 mb-0">{filteredRows.length} PDF documents</p>
      </div>
