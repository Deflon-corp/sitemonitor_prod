...
export default function ContentWithQAErrorsPdfView({ data = [] }) {
    ...
    <div className="d-flex flex-column h-100">
      <div className="mb-3">
        <h5 className="mb-1 d-flex align-items-center gap-2 text-body">
          <i
            className="isax isax-document-text fs-20 text-primary"
            aria-hidden="true"
          ></i>{" "}
          PDF Documents
        </h5>
        <p className="text-muted fs-13 mb-0">
          {filteredRows.length} PDF documents
        </p>
      </div>
      <div className="d-flex flex-wrap align-items-center justify-content-end gap-3 mb-3">
        <button
          type="button"
          className="btn btn-sm bg-primary text-white rounded-2 border-0"
          title="Filter"
        >
                ...
                <tr key={row.id}>
                  ...
                  <td className="py-3 pe-4">
                    <div className="d-flex align-items-center gap-1">
                      <button
                        type="button"
                        className="btn btn-sm btn-light text-primary px-2 py-1 fs-12 d-inline-flex align-items-center gap-1"
                        title="Open page issues"
                      >
                      ...
                      >
                        <i
                          className="isax isax-search-normal-1 fs-16"
                          aria-hidden="true"
                        ></i>
                      </button>
                    </div>
