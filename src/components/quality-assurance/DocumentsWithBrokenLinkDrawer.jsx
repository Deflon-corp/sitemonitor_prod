...
export default function DocumentsWithBrokenLinkDrawer({
  ...
  const exportPDF = useCallback(async function() {
    ...
    autoTable(doc, {
      ...
      startY: 10,
      styles: { fontSize: 8 },
      columnStyles: { 0: { cellWidth: "wrap" }, 1: { cellWidth: "wrap" }, 2: { cellWidth: 20 }, 3: { cellWidth: 18 } },
    });
          ...
          <div className="d-flex align-items-flex-start gap-3 justify-content-between flex-wrap">
            <div className="d-flex align-items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <h5 id="documents-with-broken-link-drawer-title" className="mb-1 fw-semibold text-body">
                  {drawerTitle}
                </h5>
                <a
                  href={displayUrl}
        ...
        <div className="flex-grow-1 overflow-auto p-4">
          {filteredRows.length === 0 ? (
            <div className="card border border-secondary border-opacity-25 rounded-3 shadow-sm">
              <div className="card-body py-5 text-center text-muted">No content was found</div>
            </div>
          ) : (
