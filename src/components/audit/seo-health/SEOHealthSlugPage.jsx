...
import {
  getSeoIssuePageTitle,
  getSeoIssueBySlug,
} from "@/lib/seo-health-config";
        ...
        <div className="d-flex align-items-center justify-content-between mb-4">
          <div>
            ...
            <p className="text-muted fs-14 mb-0">
              Detailed view of pages affected by {pageTitle.toLowerCase()}
            </p>
          </div>
          <button
            ...
            <div className="card border-0 shadow-sm h-100">
              <div className="card-body">
                ...
                <p className="fs-12 text-muted mt-3">
                  {totalCount > 0
                    ? "Optimization required for these pages."
                    : "No critical issues found in the latest scan."}
                </p>
              </div>
            </div>
          </div>
