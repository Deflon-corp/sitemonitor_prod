...
export default function SpellCheckerDetailPage() {
  ...
  useEffect(() => {
    if (slug && !getSpellCheckerAuditBySlug(slug))
  ...
  const chartData = useMemo(() => {
    ...
    const topPages = [...pages]
      .sort((a, b) => (b.targetedIssueCount || 0) - (a.targetedIssueCount || 0))
      .slice(0, 5);
    return {
      series: [
        {
          name: "Issues",
          data: topPages.map((p) => p.targetedIssueCount || 1),
        },
      ],
  ...
  const brokenLinksList = useMemo(() => {
    ...
    pages.forEach((p) => {
      ...
      if (
        links.length === 0 &&
        (p.targetedIssueCount > 0 || p.brokenLinksCount > 0)
      ) {
        list.push({
          ...
          <div className="d-flex align-items-center justify-content-between mb-4">
            <div>
              ...
              <p className="text-muted fs-14 mb-0">
                List of all dead links and the pages where they were found
              </p>
            </div>
            <button
          ...
          <div className="row g-4 mb-4">
              ...
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body">
                  ...
                  <p className="fs-12 text-muted mt-3">
                    Fixing broken links restores crawl budget and enhances user
                    navigation.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-8">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body">
                  <h6 className="text-muted fs-13 mb-3 text-uppercase fw-bold ls-1">
                    Broken Links count per Page (Top 5)
                  </h6>
                  <Suspense
                    fallback={
            ...
            <div className="card-header border-0 d-flex align-items-center justify-content-between flex-wrap gap-2 bg-transparent py-3">
              <h6 className="mb-0 fw-semibold d-flex align-items-center">
                ...
                <span
                  ...
                  title="List of specific dead links found across crawled pages"
                >
            ...
            <div className="card-body p-0">
              <div className="table-responsive">
                <table className="table table-hover mb-0">
                  <thead className="bg-light">
                    <tr>
                      <th
                        className="fw-semibold text-body fs-13 border-0 py-3"
                        style={{ width: "40%" }}
                      >
                  ...
                  <tbody>
                    {isLoading ? (
                      ...
                      <tr>
                        ...
                        >
                          No broken links were found on your website. Excellent
                          job!
                        </td>
                      </tr>
                    ) : (
                        ...
                        <tr key={idx}>
                          <td className="py-3">
                            <a
                              ...
                              className="text-danger text-decoration-none text-break fw-medium fs-13"
                            >
                              {item.brokenUrl}
                            </a>
                          </td>
                          <td className="py-3">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-primary text-decoration-none text-break fs-13"
                            >
                              {item.foundPage}
                            </a>
                          </td>
                          <td className="py-3 text-muted fs-13">
                            {item.anchorText}
                          </td>
              ...
              <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 p-3 border-top bg-transparent">
                ...
                <span className="fs-13 text-muted">
                  ...
                  {Math.min(page * limit, totalCount)} of {totalCount} pages
                </span>
      ...
      <div className="content">
        <div className="d-flex align-items-center justify-content-between mb-4">
          <div>
            ...
            <p className="text-muted fs-14 mb-0">
              Detailed view of pages with content issues
            </p>
          </div>
          <button
            className="btn btn-outline-primary btn-sm"
          ...
          <div className="col-lg-4">
            <div className="card border-0 shadow-sm h-100">
              <div className="card-body">
                ...
                <p className="fs-12 text-muted mt-3">
                  Fixing these issues improves content quality and user trust.
                </p>
              </div>
            </div>
          </div>
          ...
          {!isLoading && pages.length === 0 ? (
            <div className="card border-0 shadow-sm p-5 text-center">
              ...
              <p className="text-muted mb-0">
                No spelling issues were found in this category.
              </p>
            </div>
          ) : (
