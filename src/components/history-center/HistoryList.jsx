...
export default function HistoryList() {
    ...
    const totalPages = Math.max(1, Math.ceil(SAMPLE_HISTORY.length / rowsPerPage));
                    ...
                    <div className="col-md-4">
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body">
                                <h6 className="text-muted small fw-medium mb-1">Total amount of content</h6>
                        ...
                        <div className="card border-0 shadow-sm h-100">
                            <div className="card-body">
                                <h6 className="text-muted small fw-medium mb-1 d-flex align-items-center gap-1">
                                    Content with issues
                                    <i className="isax isax-information text-muted" style={{ fontSize: "0.75rem" }} aria-hidden="true" />
                                </h6>
                                <div className="d-flex align-items-baseline gap-2">
                                    <span className="fs-4 fw-bold text-body">500</span>
                                    <span className="text-muted small">0%</span>
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex align-items-baseline gap-2">
                                    ...
                                    <span className="text-success small d-flex align-items-center gap-1">
                                        <i className="isax isax-arrow-down-3" aria-hidden="true" /> 40.2%
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="card border-0 shadow-sm mb-4">
                    <div className="card-body">
                        ...
                        >
                            ...
                            >
                                <line x1="48" y1="220" x2="652" y2="220" stroke="var(--bs-border-color)" strokeWidth="1" />
                                <line x1="48" y1="36" x2="48" y2="220" stroke="var(--bs-border-color)" strokeWidth="1" />
                                <polyline fill="none" stroke="#8b5cf6" strokeWidth="2" points="80,60 180,80 280,70 380,90 480,85 580,95" />
                                <polyline fill="none" stroke="#22c55e" strokeWidth="2" points="80,200 180,180 280,160 380,140 480,120 580,100" />
                                <text x="350" y="250" textAnchor="middle" className="small text-muted" fill="currentColor">
                                    Dec 10
                                </text>
                                <text x="100" y="30" textAnchor="middle" className="small text-muted" fill="currentColor">
                                    Pages
                                </text>
                            </svg>
                        </div>
                        ...
                        <div className="d-flex flex-wrap gap-3 gap-md-4">
                            {CHART_LEGEND.map((item) => (
                                <span key={item.label} className="d-flex align-items-center gap-1 small text-muted">
                                    <span
                                        style={{
                                            width: 12,
                                            height: 12,
                            ...
                            <table className="table table-hover align-middle mb-0">
                                <thead>
                                    <tr className="border-bottom border-secondary border-opacity-25 bg-body-tertiary bg-opacity-50">
                                        <th className="py-3 ps-4 text-body fs-13 fw-semibold">Crawled at</th>
                                        <th className="py-3 text-body fs-13 fw-semibold">Pages with Accessibility Issues</th>
                                        <th className="py-3 text-body fs-13 fw-semibold">Pages with SEO Opportunities</th>
                                        <th className="py-3 text-body fs-13 fw-semibold">Pages with QA Issues</th>
                                        <th className="py-3 text-body fs-13 fw-semibold">Pages with Policy Issues</th>
                                        <th className="py-3 text-body fs-13 fw-semibold">Pages crawled</th>
                                        <th className="py-3 text-body fs-13 fw-semibold">Documents crawled</th>
                                        <th className="py-3 pe-4 text-body fs-13 fw-semibold">Changes since previous crawl</th>
                                    </tr>
                                </thead>
                                <tbody>
                    ...
                    <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 px-4 py-3 border-top">
                        <div className="d-flex align-items-center gap-2">
                            ...
                            <span className="text-muted small">
                                {(currentPage - 1) * rowsPerPage + 1}–{Math.min(currentPage * rowsPerPage, SAMPLE_HISTORY.length)} of{" "}
