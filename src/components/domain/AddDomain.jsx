...
const AddDomain = () => {
    ...
    const validateForm = () => {
        ...
        if (maxScannedPages !== "" && (isNaN(maxScannedPages) || Number(maxScannedPages) < 1)) {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (response.data && response.data.success) {
                showToast(response.data.message || (isEditMode ? "Domain updated successfully" : "Domain created successfully"), "success");
            ...
            <div className="add-domain-actions d-flex gap-2 mt-4 pt-3 border-top">
                ...
                >
                    {isLoading ? (
                        ...
                        isEditMode ? "Update domain" : "Save Domain"
                    )}
                </button>
