...
const UpdateDomain = () => {
    ...
    const handleAddInternalUrl = () => {
        if (internalUrl.trim()) {
            setInternalUrls([...internalUrls, { operator: internalOperator, url: internalUrl.trim() }]);
            setInternalUrl("");
        }
    };
    ...
    const validateForm = () => {
        ...
        if (maxScannedPages !== "" && (isNaN(maxScannedPages) || Number(maxScannedPages) < 0)) {
            newErrors.maxScannedPages = "Must be a non-negative number";
        }
    
        // Scan frequency validation
        if (scanFrequency !== "" && (isNaN(scanFrequency) || Number(scanFrequency) < 1)) {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (response.data && response.data.success) {
                showToast(response.data.message || "Domain updated successfully", "success");
        ...
        <div className="content update-domain-content">
            ...
            <div className="update-domain-header mb-4 d-flex align-items-start justify-content-between gap-3">
                <div>
                    ...
                    <p className="update-domain-subtitle text-muted mb-0">Update the details for this domain.</p>
                </div>
                ...
                <div className="col-lg-6">
                    ...
                    <div className="card add-domain-card border-0 shadow-sm mb-4">
                        <div className="card-header add-domain-card-header bg-white border-0 py-3 px-4 d-flex align-items-center justify-content-between">
                            ...
                            >
                                <i className={`isax ${openDomainDetails ? "isax-arrow-up-1" : "isax-arrow-down-1"}`}></i>
                            </button>
                        </div>
                    ...
                    <div className="card add-domain-card border-0 shadow-sm mb-4">
                        <div className="card-header add-domain-card-header bg-white border-0 py-3 px-4 d-flex align-items-center justify-content-between">
                            ...
                            >
                                <i className={`isax ${openScanCrawl ? "isax-arrow-up-1" : "isax-arrow-down-1"}`}></i>
                            </button>
                        </div>
                            ...
                            <div id="scan-crawl">
                                <div className="card-body pt-0 px-4 pb-4">
                                    <div className="d-flex align-items-center justify-content-between mb-3">
                                        <label className="form-label mb-0">Crawl Automatically</label>
                                        <div className="d-flex align-items-center gap-2">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (errors.maxScannedPages) setErrors({ ...errors, maxScannedPages: "" });
                                            }}
                                            min="0"
                                        />
                                        {errors.maxScannedPages && <div className="invalid-feedback">{errors.maxScannedPages}</div>}
                                    </div>
                                        ...
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (errors.scanFrequency) setErrors({ ...errors, scanFrequency: "" });
                                                }}
                                                min="1"
                                            />
                                            {errors.scanFrequency && <div className="invalid-feedback">{errors.scanFrequency}</div>}
                                        </div>
                                        <div className="col-md-6 mb-3">
                                    ...
                                    {/* Toggle Switches */}
                                    {[
                                        { label: "Scan subdomains", state: scanSubdomains, setter: setScanSubdomains },
                                        { label: "Spelling ignore capitalized words", state: spellingIgnoreCaps, setter: setSpellingIgnoreCaps },
                                        { label: "Case sensitive URLs", state: caseSensitiveUrls, setter: setCaseSensitiveUrls },
                                        { label: "Render pages and execute JS while crawling", state: renderPagesExecuteJs, setter: setRenderPagesExecuteJs },
                                        { label: "Mark 403 as broken link", state: mark403AsBroken, setter: setMark403AsBroken },
                                        { label: "Ignore canonical URLs", state: ignoreCanonicalUrls, setter: setIgnoreCanonicalUrls },
                                        { label: "Use language attribute", state: useLanguageAttribute, setter: setUseLanguageAttribute },
                ...
                <div className="col-lg-6">
                    ...
                    <div className="card add-domain-card border-0 shadow-sm mb-4">
                        <div className="card-header add-domain-card-header bg-white border-0 py-3 px-4 d-flex align-items-center justify-content-between">
                            ...
                            >
                                <i className={`isax ${openFeatures ? "isax-arrow-up-1" : "isax-arrow-down-1"}`}></i>
                            </button>
                        </div>
                    ...
                    <div className="card add-domain-card border-0 shadow-sm mb-4">
                        <div className="card-header add-domain-card-header bg-white border-0 py-3 px-4 d-flex align-items-center justify-content-between">
                            ...
                            >
                                <i className={`isax ${openAdvanced ? "isax-arrow-up-1" : "isax-arrow-down-1"}`}></i>
                            </button>
                        </div>
                        ...
                        {openAdvanced && (
                            <div id="advanced-options">
                                <div className="card-body pt-0 px-4 pb-4">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="d-flex align-items-center gap-2">
                                            <input
                                                ...
                                                onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), handleAddPathConstraint())}
                                            />
                                            <button
                                                type="button"
                                        ...
                                        {pathConstraints.length > 0 && (
                                            <div className="mt-2">
                                                {pathConstraints.map((p, idx) => (
                                                    <div key={idx} className="badge bg-light text-dark border d-inline-flex align-items-center gap-2 me-2 mb-2 p-2 fw-normal">
                                                        <span>{p}</span>
                                                        <i
                                        ...
                                        <div className="row g-2 mb-2 align-items-center">
                                            ...
                                            <div className="col">
                                                ...
                                                <input
                                                    ...
                                                    onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), handleAddInternalUrl())}
                                                />
                                            </div>
                                        ...
                                        {internalUrls.length > 0 && (
                                            <div className="mt-1">
                                                {internalUrls.map((item, idx) => (
                                                    <div key={idx} className="badge bg-light text-dark border d-inline-flex align-items-center gap-2 me-2 mb-2 p-2 fw-normal">
                                                        <span className="text-primary-emphasis fw-bold">{item.operator}:</span>
                                                        <span>{item.url}</span>
                                                        <i
                                                            className="isax isax-close-circle text-danger"
                                                            style={{ cursor: "pointer", fontSize: "14px" }}
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label">Ignored spellings/Keywords</label>
                                        <div className="d-flex align-items-center gap-2">
                                            <input
                                                type="text"
                                                className="form-control"
                                                ...
                                                onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), handleAddIgnoredSpelling())}
                                            />
                                            <button
                                                type="button"
                                                className="btn btn-primary btn-sm p-1 flex-shrink-0"
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label">Terms and condition check</label>
                                        <div className="d-flex align-items-center gap-2">
                                            <input
                                                type="text"
                                                className="form-control"
                                                ...
                                                onKeyDown={(e) => e.key === 'Enter' && (e.preventDefault(), handleAddTermsCondition())}
                                            />
                                            <button
                                                type="button"
                                                className="btn btn-primary btn-sm p-1 flex-shrink-0"
