...
const SAMPLE = [
  {
    id: 1,
    link: "investor.service@example.com",
    type: "Email",
    responseCode: "200",
  },
...
export default function InventoryEmailAddressesView({
  items = SAMPLE,
  variant,
}) {
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div className="d-flex align-items-center gap-2">
              <span className="avatar avatar-40 avatar-rounded bg-primary bg-opacity-10 text-primary d-flex align-items-center justify-content-center">
                <i className="isax isax-sms fs-22" aria-hidden={true} />
              </span>
              <div>
                <h6 className="mb-0 fw-semibold">Email addresses</h6>
              ...
              <tbody>
                {paginatedItems.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-body">{row.responseCode}</td>
                  </tr>
                ))}
              </tbody>
            </table>
