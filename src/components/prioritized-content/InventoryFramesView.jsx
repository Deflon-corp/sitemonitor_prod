...
const DETAILS_SAMPLE = [
  {
    id: 1,
    link: "https://example.com/frames/nav",
    type: "Frame",
    responseCode: "200",
  },
  {
    id: 2,
    link: "https://example.com/frames/sidebar",
    type: "Frame",
    responseCode: "200",
  },
  {
    id: 3,
    link: "https://example.com/frames/content",
    type: "Frame",
    responseCode: "200",
  },
  {
    id: 4,
    link: "https://example.com/frames/footer",
    type: "Frame",
    responseCode: "200",
  },
  {
    id: 5,
    link: "https://example.com/legacy/frame-main",
    type: "Frame",
    responseCode: "200",
  },
];
  ...
  return (
    <>
                ...
                {paginatedItems.map((row) => (
                  <tr key={row.id}>
                    ...
                    <td className="pe-4 py-3 text-end">
                      <button
                        type="button"
                        className="btn btn-link p-0 border-0 d-flex flex-column align-items-end text-decoration-none"
                        onClick={() => {
                          setSelectedResourceUrl(row.url);
                          setPagesDrawerOpen(true);
                        }}
                        aria-label={`Pages with this frame (${row.pageCount} page${row.pageCount !== 1 ? "s" : ""})`}
                      >
                        <span
      ...
      <PageDetailsDrawer
        ...
        defaultInventorySubView={DEFAULT_INVENTORY_SUB_VIEW}
        backdropZIndex={1070}
        panelZIndex={1075}
      />
    </>
