...
const SAMPLE = [
  {
    id: 1,
    link: "https://cms-assets.example.com/files/export-2025-03.dat",
    type: "Other",
    responseCode: "200",
  },
  {
    id: 2,
    link: "https://cms-assets.example.com/files/config-backup.bak",
    type: "Other",
    responseCode: "200",
  },
  {
    id: 3,
    link: "https://cms-assets.example.com/files/template.vsd",
    type: "Other",
    responseCode: "200",
  },
  {
    id: 4,
    link: "https://cms-assets.example.com/files/legacy-document.odt",
    type: "Other",
    responseCode: "200",
  },
  {
    id: 5,
    link: "https://cms-assets.example.com/files/report.rtf",
    type: "Other",
    responseCode: "200",
  },
  {
    id: 6,
    link: "https://cms-assets.example.com/files/data-export.csv",
    type: "Other",
    responseCode: "200",
  },
  {
    id: 7,
    link: "https://cms-assets.example.com/files/sitemap.xml",
    type: "Other",
    responseCode: "200",
  },
  {
    id: 8,
    link: "https://cms-assets.example.com/files/manifest.json",
    type: "Other",
    responseCode: "200",
  },
];
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div className="d-flex align-items-center gap-2">
              <span className="avatar avatar-40 avatar-rounded bg-primary bg-opacity-10 text-primary d-flex align-items-center justify-content-center">
                <i className="isax isax-file fs-22" aria-hidden="true" />
              </span>
              <div>
                <h6 className="mb-0 fw-semibold">Other files</h6>
      ...
      <div className="card border border-secondary border-opacity-25 rounded-3 shadow-sm overflow-hidden">
        <div className="card-body p-0">
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 px-4 py-3 border-top">
            ...
            <nav aria-label="Other files pagination">
...
export default InventoryOtherFilesView;
