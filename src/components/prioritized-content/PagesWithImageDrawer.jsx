...
export default function PagesWithImageDrawer({
  open,
  onClose,
  imageUrl,
  onOpenPageDetails,
  ...
  const reportBase = safeFilename("Pages-with-Image-Report");
          ...
          <div className="d-flex align-items-start justify-content-between gap-3">
            <div className="min-w-0 flex-grow-1">
              <div className="d-flex align-items-center gap-2 mb-1">
                ...
                <h5
                  id="pages-with-image-drawer-title"
            ...
            <table className="table table-hover table-striped table-borderless mb-0 align-middle">
              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={5} className="text-center py-5 text-muted">
                      No pages found embedding this image.
                    </td>
                  </tr>
                ) : (
