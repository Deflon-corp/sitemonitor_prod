...
const SAMPLE = [
  {
    id: 1,
    link: "https://example.com/personal-loans",
    type: "Outgoing link",
    responseCode: "200",
  },
  {
    id: 2,
    link: "https://example.com/home-loans",
    type: "Outgoing link",
    responseCode: "200",
  },
  {
  ...
  {
    id: 6,
    link: "https://example.com/emi-calculator",
    type: "Outgoing link",
    responseCode: "200",
  },
  {
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div className="d-flex align-items-center gap-2">
              <span className="avatar avatar-40 avatar-rounded bg-primary bg-opacity-10 text-primary d-flex align-items-center justify-content-center">
                <i className="isax isax-arrow-right fs-22" aria-hidden="true" />
              </span>
              <div>
                <h6 className="mb-0 fw-semibold">Outgoing links</h6>
            ...
            >
              <input
                ...
                aria-label="Search outgoing links"
              />
            </div>
          </div>
        </div>
      ...
      <div className="card border border-secondary border-opacity-25 rounded-3 shadow-sm overflow-hidden">
        <div className="card-body p-0">
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 px-4 py-3 border-top">
            ...
            <nav aria-label="Outgoing links pagination">
...
export default InventoryOutgoingLinksView;
