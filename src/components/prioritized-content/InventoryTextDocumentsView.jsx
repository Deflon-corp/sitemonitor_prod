...
const SAMPLE = [
  {
    id: 1,
    link: "https://cms-assets.example.com/docs/terms-and-conditions.txt",
    type: "Text document",
    responseCode: "200",
  },
  {
    id: 2,
    link: "https://cms-assets.example.com/docs/privacy-policy.txt",
    type: "Text document",
    responseCode: "200",
  },
  {
    id: 3,
    link: "https://cms-assets.example.com/docs/readme.txt",
    type: "Text document",
    responseCode: "200",
  },
  {
    id: 4,
    link: "https://cms-assets.example.com/docs/faq.txt",
    type: "Text document",
    responseCode: "200",
  },
  {
    id: 5,
    link: "https://cms-assets.example.com/docs/code-of-conduct.txt",
    type: "Text document",
    responseCode: "200",
  },
  {
    id: 6,
    link: "https://cms-assets.example.com/docs/whistleblower-policy.txt",
    type: "Text document",
    responseCode: "200",
  },
  {
    id: 7,
    link: "https://cms-assets.example.com/docs/notice.txt",
    type: "Text document",
    responseCode: "200",
  },
  {
    id: 8,
    link: "https://cms-assets.example.com/docs/accessibility-statement.txt",
    type: "Text document",
    responseCode: "200",
  },
];
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div className="d-flex align-items-center gap-2">
              <span className="avatar avatar-40 avatar-rounded bg-primary bg-opacity-10 text-primary d-flex align-items-center justify-content-center">
                <i className="isax isax-document fs-22" aria-hidden={true} />
              </span>
              <div>
                <h6 className="mb-0 fw-semibold">Text documents</h6>
