...
import PagesWithFormDrawer from "./PagesWithFormDrawer";
...
export default function InventoryFormsView({ items = SAMPLE, variant }) {
  ...
  const formsReportBase = safeFilename("Forms-Report");
  const exportFormsCSV = useCallback(() => {
  ...
  const exportFormsExcel = useCallback(async () => {
    ...
    XLSX.writeFile(wb, `${formsReportBase}.xlsx`);
  }, [filteredItems, formsReportBase]);
  const exportFormsPDF = useCallback(async () => {
            ...
            <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
              <div className="d-flex align-items-center gap-2">
                <span className="avatar avatar-40 avatar-rounded bg-primary bg-opacity-10 text-primary d-flex align-items-center justify-content-center">
                  <i className="isax isax-element-3 fs-22" aria-hidden />
                </span>
                <div>
  ...
  return (
    <>
      {/* Header: icon + title + result count */}
      <div className="mb-4">
        <div className="d-flex align-items-center gap-2 mb-1">
          ...
          >
            <i className="isax isax-element-3 fs-4" aria-hidden />
          </span>
      ...
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
        ...
        <div className="d-flex align-items-center gap-2 forms-download-report-btn">
          <DownloadReportDropdown
            ...
            onExportExcel={exportFormsExcel}
            onExportPDF={exportFormsPDF}
