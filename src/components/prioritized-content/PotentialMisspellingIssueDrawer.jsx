...
export default function PotentialMisspellingIssueDrawer({
  ...
  const baseName = safeFilename(
    issue
      ? `Potential-Misspelling-${issue.word}-Pages`
      : "Potential-Misspellings-Pages-Report",
  );
  ...
  const drawerZBackdrop = _nullishCoalesce(
    backdropZIndexProp,
    () => DEFAULT_DRAWER_Z_BACKDROP,
  );
  const drawerZPanel = _nullishCoalesce(
    panelZIndexProp,
    () => DEFAULT_DRAWER_Z_PANEL,
  );
                ...
                <div className="d-flex align-items-center gap-3">
                  ...
                  <div>
                    <h6
                      ...
                      id="potential-misspelling-issue-drawer-title"
                    >
                            ...
                            <button
                              ...
                              onClick={() =>
                                _optionalChain([
                                  onOpenPageDetails,
                                  "optionalCall",
                                  (_3) => _3(p, "potential-misspellings"),
                                ])
                              }
