...
function getSamplePagesForForm(formUrl) {
...
export default function PagesWithFormDrawer({
  ...
  const reportBase = safeFilename("Pages-with-Form-Report");
  const exportCSV = () => {
  ...
  const content = (
    <>
      ...
      >
        {/* Header: close, title, target URL, download, search */}
        ...
        {/* Table: Title and URL | Views | Action */}
