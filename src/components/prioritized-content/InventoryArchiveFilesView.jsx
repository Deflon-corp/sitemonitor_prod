...
const SAMPLE = [
  {
    id: 1,
    link: "https://cms-assets.example.com/downloads/backup-2024-q4.zip",
    type: "Archive",
    responseCode: "200",
  },
  {
    id: 2,
    link: "https://cms-assets.example.com/downloads/compliance-docs.zip",
    type: "Archive",
    responseCode: "200",
  },
  {
    id: 3,
    link: "https://cms-assets.example.com/downloads/audit-reports-2025.zip",
    type: "Archive",
    responseCode: "200",
  },
  {
    id: 4,
    link: "https://cms-assets.example.com/downloads/policy-templates.zip",
    type: "Archive",
    responseCode: "200",
  },
  {
    id: 5,
    link: "https://cms-assets.example.com/downloads/legacy-documents.rar",
    type: "Archive",
    responseCode: "200",
  },
  {
    id: 6,
    link: "https://cms-assets.example.com/downloads/quarterly-data-mar25.zip",
    type: "Archive",
    responseCode: "200",
  },
  {
    id: 7,
    link: "https://cms-assets.example.com/downloads/attachments-bundle.zip",
    type: "Archive",
    responseCode: "200",
  },
  {
    id: 8,
    link: "https://cms-assets.example.com/downloads/forms-archive.zip",
    type: "Archive",
    responseCode: "200",
  },
];
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div className="d-flex align-items-center gap-2">
              <span className="avatar avatar-40 avatar-rounded bg-primary bg-opacity-10 text-primary d-flex align-items-center justify-content-center">
                <i className="isax isax-box fs-22" aria-hidden="true" />
              </span>
              <div>
                <h6 className="mb-0 fw-semibold">Archive files</h6>
      ...
      <div className="card border border-secondary border-opacity-25 rounded-3 shadow-sm overflow-hidden">
        <div className="card-body p-0">
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 px-4 py-3 border-top">
            ...
            <nav aria-label="Archive files pagination">
...
export default InventoryArchiveFilesView;
