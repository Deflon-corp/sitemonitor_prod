...
const PrioritizedContentDocumentsView = ({
  rows,
  onOpenPageDetails,
  ariaLabel = "Documents",
}) => {
  ...
  if (rows.length === 0) {
    return (
      <div className="card border-0 shadow-sm rounded-3">
        <div className="card-body d-flex align-items-center justify-content-center py-5 px-4">
          <p className="text-muted mb-0 fs-5">Good job! No issues were found</p>
        </div>
      </div>
    );
  }
...
export default PrioritizedContentDocumentsView;
