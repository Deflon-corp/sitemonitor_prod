...
export const MISSPELLINGS_SAMPLE = [
  { id: 1, word: "upto", language: "English (Australian)", dateFound: "2025-01-15", pages: 498 },
  { id: 2, word: "IRDAI", language: "English (Australian)", dateFound: "2025-01-14", pages: 497 },
  { id: 3, word: "ppi", language: "English (Australian)", dateFound: "2025-01-13", pages: 2 },
  { id: 4, word: "color", language: "English (Australian)", dateFound: "2025-01-12", pages: 2 },
  { id: 5, word: "labor", language: "English (Australian)", dateFound: "2025-01-11", pages: 1 },
];

const MisspellingsSection = ({
  ...
  return (
    <div className="d-flex flex-column h-100">
      <div className="mb-3">
        <h5 className="mb-1 fw-semibold text-body">Misspellings</h5>
      ...
      <div className="card border border-secondary border-opacity-25 rounded-3 shadow-sm flex-grow-1 min-h-0 d-flex flex-column overflow-hidden">
                ...
                <tr key={row.id}>
                  ...
                  {variant === "page" && (
                    <td className="py-3 pe-2 text-center align-middle">
                      <button type="button" className="btn btn-icon btn-sm btn-light border-0 rounded-2 text-primary" title="Open misspelling page" onClick={() => onOpenIssue?.(row.id)} aria-label="Open misspelling page">
                        <i className="isax isax-info-circle fs-18" aria-hidden="true" />
                      </button>
                    </td>
                  )}
                    ...
                    <div className="d-inline-flex align-items-center gap-1">
                      <div className="dropdown d-inline-block">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end">
                          ...
                          <li><button type="button" className="dropdown-item">Add to dictionary</button></li>
                        </ul>
                      </div>
                    </div>
                  </td>
        ...
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-2 px-4 py-3 border-top border-secondary border-opacity-25">
          ...
          <nav aria-label="Misspellings pagination">
...
export default MisspellingsSection;
