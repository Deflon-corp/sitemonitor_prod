...
const MisspellingsSection = ({
  ...
  return (
    <div className="d-flex flex-column h-100">
      ...
      <div
        className={`d-flex flex-nowrap align-items-center gap-3 mb-4 ${showLanguage ? "justify-content-between" : "justify-content-end"}`}
      >
        {showLanguage && (
          <nav
            className="nav nav-tabs border-0 gap-2 gap-md-4 mb-0 flex-shrink-0"
                      ...
                      <td className="py-3">
                        <div className="d-flex flex-column">
                          <span className="fw-medium text-primary">
                            {Number(
                              row.pages ?? row.pagesCount ?? 0,
                            ).toLocaleString()}
                          </span>
                          <span className="text-muted small">
                            {Number(row.pages ?? row.pagesCount ?? 0) === 1
                              ? "PAGE"
                              : "PAGES"}
                          </span>
                        </div>
                  ...
                  {variant === "page" && (
                    <td className="py-3 pe-2 text-center align-middle">
                      <button
                        type="button"
                        className="btn btn-icon btn-sm btn-light border-0 rounded-2 text-primary"
                        title="Open misspelling page"
                        onClick={() => onOpenIssue?.(row.id)}
                        aria-label="Open misspelling page"
                      >
                        <i
                          className="isax isax-info-circle fs-18"
                          aria-hidden="true"
