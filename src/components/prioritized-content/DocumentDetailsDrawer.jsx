...
export default function DocumentDetailsDrawer({
  ...
  const documentLink = _nullishCoalesce(
    _optionalChain([documentRow, "optionalAccess", (_2) => _2.link]),
    () => "",
  );
          ...
          <div className="d-flex align-items-start justify-content-between gap-3">
            <div className="min-w-0 flex-grow-1">
              <div className="d-flex align-items-center gap-2 mb-1">
                ...
                <h5
                  id="document-details-drawer-title"
                  className="mb-0 fw-semibold text-body"
                >
                  Document details
                </h5>
              </div>
              <p className="text-muted small mb-0 ms-4 text-break">
                {documentLink || "—"}
              </p>
              {documentRow && (
                <p className="text-muted small mb-0 ms-4 mt-1">
                  {"Notifications: "}
                  {documentRow.notifications}
                  {" · Views: "}
                  {documentRow.views}
                </p>
              )}
            ...
            <table className="table table-hover table-striped table-borderless mb-0 align-middle">
              <thead className="sticky-top bg-white">
                <tr className="border-bottom border-secondary border-opacity-25 bg-body-tertiary bg-opacity-50">
                  ...
                  <th className="py-3 fw-semibold text-body fs-13 text-nowrap">
                    Type
                  </th>
                  <th className="py-3 fw-semibold text-body fs-13 text-nowrap">
                    Response code
              ...
              <tbody>
                {paginatedRows.map((row) => (
                  <tr key={row.id}>
                    ...
                    <td className="py-3 text-body text-nowrap">{row.type}</td>
                    <td className="py-3 text-body text-nowrap">
                      {row.responseCode}
                    </td>
