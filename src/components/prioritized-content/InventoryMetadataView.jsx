...
const SAMPLE = [
  ...
  { id: 2, nameProperty: "description", content: "ASUS AMD Ryzen 7 16 GB RAM/ 512 GB SSD/ Windows 11 Home/ 15.6 inch Gaming Laptop (Graphite Black, FA506NFR-HN259WS) - Buy ASUS AMD Ryzen 7 16 GB RAM/ 512 GB SSD/ Windows 11 Home/ 15.6 inch Gaming Laptop (Graphite Black, FA506NFR-HN259WS) at best price from Example Domain." },
  { id: 3, nameProperty: "keywords", content: "ASUS AMD Ryzen 7 16 GB RAM/ 512 GB SSD/ Windows 11 Home/ 15.6 inch Gaming Laptop (Graphite Black, FA506NFR-HN259WS), gaming laptop, Example Domain" },
  { id: 4, nameProperty: "og:description", content: "ASUS AMD Ryzen 7 16 GB RAM/ 512 GB SSD/ Windows 11 Home/ 15.6 inch Gaming Laptop (Graphite Black, FA506NFR-HN259WS) - Buy ASUS AMD Ryzen 7 16 GB RAM/ 512 GB SSD/ Windows 11 Home/ 15.6 inch Gaming Laptop (Graphite Black, FA506NFR-HN259WS) at best price from Example Domain." },
  { id: 5, nameProperty: "og:image", content: "https://example.com/content/dam/examplemall-site/dam/HostedLink/220126/og_tag.png" },
  { id: 6, nameProperty: "og:locale", content: "en_IN" },
  { id: 7, nameProperty: "og:site_name", content: "Example Domain" },
  { id: 8, nameProperty: "og:title", content: "ASUS AMD Ryzen 7 16 GB RAM/ 512 GB SSD/ Windows 11 Home/ 15.6 inch Gaming Laptop (Graphite Black, FA506NFR-HN259WS) - Example Domain" },
  { id: 9, nameProperty: "og:type", content: "website" },
  { id: 10, nameProperty: "og:url", content: "https://example.com/bmall/asus-amd-ryzen-7-16-gb-ram-512-gb-ssd-windows-11-home-15-6-inch-gaming-laptop-graphite-black-fa506nfr-hn259ws/p/29185" },
  { id: 11, nameProperty: "twitter:card", content: "summary_large_image" },
  { id: 12, nameProperty: "twitter:title", content: "ASUS AMD Ryzen 7 16 GB RAM - Example Domain" },
  { id: 13, nameProperty: "twitter:description", content: "Buy ASUS AMD Ryzen 7 16 GB RAM/ 512 GB SSD/ Windows 11 Home/ 15.6 inch Gaming Laptop at best price from Example Domain." },
  { id: 14, nameProperty: "twitter:image", content: "https://example.com/content/dam/examplemall-site/dam/HostedLink/220126/og_tag.png" },
