...
const BrokenImageIssueDrawer = ({
  ...
  const totalPages = Math.max(
    1,
    Math.ceil(resolvedPagesWithImage.length / rowsPerPage),
  );
      ...
      >
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <div>
                <h6
                  ...
                  id="broken-image-issue-drawer-title"
                >
                  Broken image
                </h6>
        ...
        <div className="flex-grow-1 overflow-auto px-4 py-3">
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-body p-0">
              <h6 className="fw-semibold mb-0 px-4 pt-3 pb-2 text-body">
                All pages with this Broken Image
              </h6>
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  <span className="text-muted small">
                    ...
                    {Math.min(
                      ...
                      resolvedPagesWithImage.length,
                    )}{" "}
                    of {resolvedPagesWithImage.length}
                  </span>
                </div>
          ...
          <div className="card border-0 shadow-sm mt-3">
            <div className="card-body p-0">
              <h6 className="fw-semibold mb-0 px-4 pt-3 pb-2 text-body">
                All documents with this Broken Image
              </h6>
              <div className="table-responsive">
