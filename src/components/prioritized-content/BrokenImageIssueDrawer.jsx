...
const BrokenImageIssueDrawer = ({
  ...
  issue,
  page = null,
  pagesWithImage = DEFAULT_PAGES_WITH_IMAGE,
}) => {
  ...
  return (
    <>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="broken-image-issue-drawer-title"
      >
        <div className="border-bottom px-4 py-3 flex-shrink-0">
          <div className="d-flex align-items-flex-start justify-content-between gap-3">
            <div className="d-flex align-items-center gap-2">
              ...
              <div>
                <h6 className="mb-0 fw-semibold" id="broken-image-issue-drawer-title">Broken image</h6>
        ...
        <div className="flex-grow-1 overflow-auto px-4 py-3">
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-body p-0">
              <h6 className="fw-semibold mb-0 px-4 pt-3 pb-2 text-body">All pages with this Broken Image</h6>
          ...
          <div className="card border-0 shadow-sm mt-3">
            <div className="card-body p-0">
              <h6 className="fw-semibold mb-0 px-4 pt-3 pb-2 text-body">All documents with this Broken Image</h6>
              <div className="table-responsive">
...
export default BrokenImageIssueDrawer;
