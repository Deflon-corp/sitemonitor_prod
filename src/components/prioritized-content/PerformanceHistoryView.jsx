...
const X_LABELS = ["Feb 16", "Feb 17", "Feb 18", "Feb 19", "Feb 20", "Feb 21", "Feb 22"];
const HISTORY_DATA = [
  { scannedAt: "Feb 16, 2026 5:30 PM", performanceScore: 0, fcp: 0, lcp: 0, si: 0, tbt: 0, cls: 0, label: "Feb 16", timestamp: "February 16, 2026 5:30:20 PM" },
  { scannedAt: "Feb 17, 2026 5:30 PM", performanceScore: 0, fcp: 0, lcp: 0, si: 0, tbt: 0, cls: 0, label: "Feb 17", timestamp: "February 17, 2026 5:30:20 PM" },
  { scannedAt: "Feb 18, 2026 5:30 PM", performanceScore: 0, fcp: 0, lcp: 0, si: 0, tbt: 0, cls: 0, label: "Feb 18", timestamp: "February 18, 2026 5:30:20 PM" },
  { scannedAt: "Feb 19, 2026 5:30 PM", performanceScore: 0, fcp: 0, lcp: 0, si: 0, tbt: 0, cls: 0, label: "Feb 19", timestamp: "February 19, 2026 5:30:20 PM" },
  { scannedAt: "Feb 20, 2026 5:30 PM", performanceScore: 0, fcp: 0, lcp: 0, si: 0, tbt: 0, cls: 0, label: "Feb 20", timestamp: "February 20, 2026 5:30:20 PM" },
  { scannedAt: "Feb 21, 2026 5:30 PM", performanceScore: 0, fcp: 0, lcp: 0, si: 0, tbt: 0, cls: 0, label: "Feb 21", timestamp: "February 21, 2026 5:30:20 PM" },
  { scannedAt: "Feb 22, 2026 5:32 PM", performanceScore: 0, fcp: 0, lcp: 0, si: 0, tbt: 0, cls: 0, label: "Feb 22", timestamp: "February 22, 2026 5:32:03 PM" },
];
...
export default function PerformanceHistoryView() {
  ...
  const hoveredRow = hoveredIndex != null ? HISTORY_DATA[hoveredIndex] : null;
        ...
        , React.createElement('div', { className: "card-body p-4" }
          , React.createElement('div', {
            ...
            , React.createElement('svg', {
              ...
              , series.map((s) => {
                const points = HISTORY_DATA.map((row, i) => ({ x: xScale(i), y: s.scale(s.getVal(row)) }));
