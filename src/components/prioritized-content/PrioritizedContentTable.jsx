...
const FILTERS = [
  {
    ...
    href: "/prioritized-content?filter=all",
  },
  {
    key: "pages",
    label: "Pages",
    icon: "isax-document-text",
    href: "/prioritized-content?filter=pages",
  },
  {
    key: "pdf",
    label: "PDF Documents",
    icon: "isax-document-text",
    href: "/prioritized-content?filter=pdf",
  },
  {
    key: "images",
    label: "Images",
    icon: "isax-image",
    href: "/prioritized-content?filter=images",
  },
  {
    key: "other",
    label: "Other Documents",
    icon: "isax-document",
    href: "/prioritized-content?filter=other",
  },
];
    ...
    const fetchData = async () => {
      ...
      try {
        if (currentFilter === "all" || currentFilter === "pages") {
          ...
          const docRes = await inventoryApi.getInventoryDetails(domainId, {
            type: "documents",
            limit: 100,
          });
            ...
            const pdfDocs = allDocs
              .filter((d) => {
                ...
                return (
                  ...
                  d.document_type?.toLowerCase() === "pdf"
                );
              })
              .map((d) => ({
          ...
          const imgRes = await inventoryApi.getInventoryDetails(domainId, {
            type: "images",
            limit: 100,
          });
  ...
  return (
    <div className="prioritized-content-page">
      ...
      {!domainId ? (
        ...
        <div
          className="alert alert-danger d-flex align-items-center py-2 px-3"
          role="alert"
        >
        ...
        <>
          <PrioritizedContentOtherDocumentsView
            rows={others}
            onOpenPageDetails={openPageDetails}
          />
          <PageDetailsMisspellingsDrawer
