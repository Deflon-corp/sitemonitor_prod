...
import { createUserApi, getUserByIdApi, updateUserApi } from "../../api/userApi";
...
const AddUser = ({ isEditMode = false }) => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                showToast(response.message || (isEditMode ? "User updated successfully" : "User created successfully"), "success");
                                        ...
                                        <div className="col-md-6">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <button
                                                    ...
                                                    tabIndex="-1"
                                                >
                                                    <i className={`isax ${showConfirmPassword ? "isax-eye-slash" : "isax-eye"}`}></i>
                                                </button>
                                            </div>
