...
const SAMPLE_ROWS = [
  ...
  },
  {
    id: "3",
    title: "(No title found)",
    url: "https://example.com/bmall/dell-15r-intel-core-i5/p/29186",
    unwanted: 0,
    required: 0,
    matches: 1,
    priority: "High",
  ...
  },
  {
    id: "4",
    title: "(No title found)",
    url: "https://example.com/bmall/hp-notebook-amd-4-gb-ram/p/29187",
    unwanted: 0,
    required: 0,
    matches: 1,
    priority: "Medium",
...
const ContentWithPolicyMatchesHtmlTabContent = ({
  domainUrl,
  onOpenPageDetails,
}) => {
...
export default ContentWithPolicyMatchesHtmlTabContent;
