...
const NewRuleLinkTextDrawer = ({ open, onClose, onSave, initialData }) => {
  ...
  return (
    <>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="new-rule-link-text-title"
      >
        <div className="border-bottom border-secondary border-opacity-25 px-4 py-3 flex-shrink-0">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <h5 id="new-rule-link-text-title" className="mb-0 fw-semibold text-body">New rule - Link text</h5>
              <p className="text-muted fs-13 mb-0 mt-1">Search for pages that contains this text in links</p>
            </div>
          </div>
        </div>
          ...
          <div className="mb-4">
            ...
            <div className="d-flex gap-2 mb-2">
              ...
              <input
                ...
                placeholder="Link text to search for"
              />
            </div>
            <div className="d-flex align-items-start gap-2 flex-wrap">
              <div className="form-check">
                <input
                  ...
                  type="radio"
                  name="linkTextContaining"
                  id="linkTextContaining"
                  checked={containing === "containing"}
                  onChange={() => setContaining("containing")}
                />
                <label className="form-check-label fs-13" htmlFor="linkTextContaining">Containing</label>
              </div>
              <div className="form-check">
                <input
                  className="form-check-input"
                  type="radio"
                  name="linkTextContaining"
                  id="linkTextNotContaining"
                  checked={containing === "not-containing"}
                  onChange={() => setContaining("not-containing")}
                />
                <label className="form-check-label fs-13" htmlFor="linkTextNotContaining">Not containing</label>
              </div>
            </div>
...
export default NewRuleLinkTextDrawer;
