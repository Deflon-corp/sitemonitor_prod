...
/** Sample data for Documents – replace with API */
...
const ContentWithPolicyMatchesDocumentsTabContent = ({ domainUrl, onOpenPageDetails }) => {
...
export default ContentWithPolicyMatchesDocumentsTabContent;
