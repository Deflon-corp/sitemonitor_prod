...
const NewRuleImageTextLengthDrawer = ({
  open,
  onClose,
  onSave,
  initialData,
      ...
      >
        <div className="border-bottom border-secondary border-opacity-25 px-4 py-3 flex-shrink-0">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <h5
                id="new-rule-image-text-length-title"
                className="mb-0 fw-semibold text-body"
              >
                New rule - Image text length
              </h5>
              <p className="text-muted fs-13 mb-0 mt-1">
                Define when the rule should apply for image texts
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-grow-1 overflow-auto p-4">
          ...
          <div className="mb-4">
            <label className="form-label text-body fs-13">
              Characters (Number of characters in image text):
            </label>
