...
const NewRuleHeadingTextDrawer = ({ open, onClose, onSave, initialData }) => {
  ...
  useEffect(() => {
    if (open && initialData) {
      ...
      setHeadingTypes(
        initialData?.headingTypes !== undefined ? initialData.headingTypes : "",
      );
      setSearchType(
      ...
      >
        <div className="border-bottom border-secondary border-opacity-25 px-4 py-3 flex-shrink-0">
          <div className="d-flex align-items-center gap-2">
            ...
            <div>
              <h5
                id="new-rule-heading-text-title"
                className="mb-0 fw-semibold text-body"
              >
                New rule - Heading text
              </h5>
              <p className="text-muted fs-13 mb-0 mt-1">
                Search for text in headers (h1,h2,h3,h4,h5,h6)
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mb-4">
            ...
            <div className="d-flex align-items-start gap-2 flex-wrap">
              ...
              <div className="form-check">
                ...
                <label
                  className="form-check-label fs-13"
                  htmlFor="headingTextNotContaining"
                >
                  Not containing
                </label>
              </div>
