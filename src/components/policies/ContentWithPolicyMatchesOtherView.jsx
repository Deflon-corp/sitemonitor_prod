...
/** Sample data for Other Documents – replace with API */
...
const ContentWithPolicyMatchesOtherView = ({ data = [] }) => {
  ...
  const reportName = "Content-with-Policy-Matches-Other";
  ...
  const exportExcel = useCallback(async () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Other Documents");
  ...
  return (
    <div className="d-flex flex-column h-100">
      <div className="mb-3">
        ...
        <p className="text-muted fs-13 mb-0">Found {filteredRows.length} other documents</p>
      </div>
...
export default ContentWithPolicyMatchesOtherView;
