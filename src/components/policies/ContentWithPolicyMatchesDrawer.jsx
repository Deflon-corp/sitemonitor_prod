  ...
  return createPortal(
    <>
      ...
      <div
        ...
        style={{ zIndex: DRAWER_Z_PANEL, width: "min(95%, 1400px)", maxWidth: "1400px" }}
        role="dialog"
        aria-modal="true"
        ...
        <div className="border-bottom border-secondary border-opacity-25 px-4 py-3 flex-shrink-0">
          <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap">
            <div className="d-flex align-items-center gap-3">
              ...
              <h2 id="content-policy-matches-title" className="mb-0 fw-semibold text-body fs-5">Content with Policy Matches</h2>
            </div>
            <div className="d-flex align-items-center gap-2">
              <button
                ...
                aria-label="Download"
              >
                <i className="isax isax-document-download fs-18 text-body" aria-hidden="true" />
              </button>
              <button
                type="button"
                className="btn btn-icon btn-sm btn-light border border-secondary border-opacity-25 rounded-2"
                ...
                aria-label="Filter"
              >
                <i className="isax isax-filter fs-18 text-body" aria-hidden="true" />
              </button>
              <input
                type="search"
          ...
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mt-3 pt-2 border-top border-secondary border-opacity-25">
            <div className="d-flex align-items-center gap-2">
              <span className="text-muted small d-flex align-items-center gap-1">
                <i className="isax isax-message-text fs-16" aria-hidden="true" />
                Policy note
              </span>
              <span className="text-body small">Compliance 0%</span>
              <span className="text-muted small">0 Pages (0%) in compliance.</span>
            </div>
            <span className="text-body fw-medium small">{pagesToFix} Pages (0%) to fix</span>
          </div>
