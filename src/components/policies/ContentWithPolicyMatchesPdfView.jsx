...
const ContentWithPolicyMatchesPdfView = () => {
  ...
  const reportName = "Content-with-Policy-Matches-PDF";
  ...
  const exportExcel = useCallback(async () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "PDF Documents");
  ...
  return (
    <div className="d-flex flex-column h-100">
      <div className="mb-3">
        ...
        <p className="text-muted fs-13 mb-0">Found {filteredRows.length} PDF documents</p>
      </div>
...
export default ContentWithPolicyMatchesPdfView;
