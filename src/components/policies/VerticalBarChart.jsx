...
const VerticalBarChart = ({
  ...
  return (
    <div className="d-flex align-items-end justify-content-around gap-1" style={{ height: CHART_HEIGHT + 44 }}>
      {items.map(({ label, value }) => {
        ...
        return (
          <div key={label} className="d-flex flex-column align-items-center flex-grow-1">
            ...
            <span className="text-muted fs-12 text-center mt-1 text-truncate w-100">{label}</span>
          </div>
        );
      })}
    </div>
