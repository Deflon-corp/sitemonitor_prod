...
const ExternalPdfTrendChart = ({
  labels = ["Dec 09", "Feb 15"],
  reviewedData = [],
  pendingData = [],
}) => {
        ...
        <div className="d-flex justify-content-center gap-4 mt-3">
          <span className="d-inline-flex align-items-center gap-2 small text-body">
            <span
              ...
              style={{ width: 10, height: 10, backgroundColor: AMBER_EXT }}
              aria-hidden="true"
            ></span>
            PDF files pending
          </span>
    ...
    <div className="external-pdfs-view">
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        <div>
          ...
          >
            A list of all PDF documents hosted externally but linked from your
            site, identified during the website scan.
          </p>
        </div>
      </div>
